...
export const AGENT_NAME = "Cédric";
export const AGENT_CODENAME = "Nomade";

// Codes to be given to Cédric by his contacts
// Step 1 -> 2: 1860
// Step 2 -> 3: 0600
// Step 3 -> 4: 1945
// Step 4 -> Final: BERLIN
...
export const MISSION_STEPS: MissionStep[] = [
  {
    ...
    objective: "Quitter la place vers les jardins (Promenade du Paillon / Jardin Albert Ier) et trouver un banc précis pour rencontrer la personne suivante.",
    unlockCode: "1860" 
  },
  {
    id: 2,
    ...
    objective: "Rejoindre la Colline du Château et viser un belvédère avec vue panoramique sur la Baie des Anges, le Vieux-Nice et le port.",
    unlockCode: "0600"
  },
  {
    id: 3,
    ...
    objective: "Redescendre et rejoindre le Port Lympia, zone portuaire au pied de la colline.",
    unlockCode: "1945"
  },
  {
    id: 4,
    ...
    objective: "Rejoindre le centre-ville et trouver le 1 Rue de la Liberté.",
    unlockCode: "BERLIN",
    isFinal: true
  }
];
